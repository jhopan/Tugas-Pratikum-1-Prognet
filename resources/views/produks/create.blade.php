                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('produks.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control mt-1 block w-full border-gray-300 rounded-md shadow-sm" name="nama_produk" required>
                        </div>
                        <div class="mb-3">
                            <label for="deskripsi" class="form-label font-semibold">Deskripsi</label>
                            <textarea class="form-control mt-1 block w-full border-gray-300 rounded-md shadow-sm" name="deskripsi" rows="5" required></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="harga" class="form-label font-semibold">Harga</label>
                            <input type="number" step="0.01" class="form-control mt-1 block w-full border-gray-300 rounded-md shadow-sm" name="harga" required>
                        </div>
                        <div class="mb-3">
                            <label for="stok" class="form-label font-semibold">Stok</label>
                            <input type="number" class="form-control mt-1 block w-full border-gray-300 rounded-md shadow-sm" name="stok" required>
                        </div>
                        <div class="mt-4">
